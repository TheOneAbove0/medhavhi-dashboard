...
export default function SIdebar() {
  ...
  return (
    <div className="w-[209px]   h-screen mx-2 flex flex-col overflow-auto">
  ...
  {menuItems.map((menuItem, index) => (
    ...
    >
      ...
      <div>
        ...
        <div className="flex items-center gap-2 cursor-pointer   w-48 px-5 mx-auto py-3 rounded-lg px-5 ">
          <svg
            width="1em"
            height="1em"
            viewBox="0 0 16 16"
