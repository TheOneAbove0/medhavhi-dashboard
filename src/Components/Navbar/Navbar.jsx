...
export default function Navbar() {
  return (
    <div class="bg-white  w-full   h-[84px] px-6 py-4 flex justify-between items-center  sticky top-0 z-50">
      <div class=" items-center">
        <div class="flex items-center gap-3 text-Jet leading-6 tracking-[0.024] text-lg">
          <span>
            Good Morning <strong>Medhavhi</strong>
          </span>
        </div>
      </div>
      <div class="lg:flex-1 lg:max-w-sm flex justify-between items-center gap-8">
        ...
        <div class="w-10 h-10 cursor-pointer  rounded-full overflow-hidden border  ">
